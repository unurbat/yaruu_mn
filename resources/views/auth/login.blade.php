...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="text">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
				...
				<div class="form-group">
					<div class="col-md-6 col-md-offset-4" style="font-size: 10px;">
						<button type="submit" class="btn btn-sm btn-danger">
							<i class="fas fa-sign-in-alt" style="font-weight: bold;"></i> Нэвтрэх
						</button>

						<a class="btn btn-link" href="{{ url('/password/reset') }}">Нууц үг мартсан</a>
					</div>
				</div>
			</form>
        </div>
